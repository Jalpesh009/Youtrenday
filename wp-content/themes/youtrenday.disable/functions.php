...
function youtrenday_scripts() {
	...
	wp_enqueue_style( 'youtrendaynewww-style', get_stylesheet_uri(), array(), '1.0.9', 'all' );
...
function my_nav_menu_profile_link( $items, $args) { 	 		
	...
	if($args->theme_location == 'header_profile_menu' && is_user_logged_in()){ 
		...
		$user_link = '<li class="rigtsidebar_username"><span>Welcome,</span></br><span class="user_email_floating1">'. $first_name . '</span></li> <li><a href="'.home_url( '/members/' . bp_core_get_username( get_current_user_id() ) . '/profile/' ) .'">Profile</a></li>';
