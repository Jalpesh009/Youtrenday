                                ...
                                <div class="row">
                                    ...
                                    if($query_video->have_posts()): 
                                        ...
                                        while ($query_video->have_posts()) : $query_video->the_post(); 
                                            ...
                                            $post_data = '<a data-authorid="'. $author_id .'" data-totalpoints="'. $points .'" data-postid="' . $competition_video->ID . '" href="' . home_url( '/members/' . bp_core_get_username( $author_id ) . '/profile/edit/group/1' ) .'"><img src="' .esc_url( get_avatar_url( $author_id  )). '"></img></a>';
                                            if( $i == 1 ){ ?>
                                        ...
                                        echo '<div class="col-md-12">There is no any Videos.</div>';
                                    endif;  ?>     
                                </div>
                            </div>     
                        <?php 
