                                    ...
                                    <div class="row mt-0">
                                        ...
                                        if($query_all_posts->have_posts()): 
                                            while ($query_all_posts->have_posts()) : $query_all_posts->the_post();  ?>
                                                 <div class="col-md-12 main_videos home_post">  
                                    ...
                                    <div class="row mt-0">
                                        ...
                                        if($query_comp_videos->have_posts()): 
                                            while ($query_comp_videos->have_posts()) : $query_comp_videos->the_post(); ?>
                                                <div class="col-md-12 main_videos home_video"> 
                                                    <?php echo show_home_postsdata( get_the_ID()); ?>
                                                </div>   
                                            <?php 
                                            endwhile;
                                        ...
                                        if(  $date_now <= $comp_end_date  ){  ?> 
                                            <div class="upcoming-comp bg-light common_sidebar_cls">
                                                ...
                                                <div class="next_week_comp">
                                                    <?php  if(  $date_now >= $comp_start_date  ){  ?>
            ...
            <div class="modal-content py-0"> 
                ...
                <div class="modal-body px-0">   
                    <div class="social_sharePost">   
                        ...
                        <a class="social-sharing-icon social-sharing-icon-facebook" data-network="facebook" data-id="" data-title="" data-desc="" data-image="" target="_new" ><i class="fa fa-facebook"></i></a>
