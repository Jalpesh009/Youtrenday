                        ...
                        <div class="row  buddypress-wrap  image-content-sec">
                            ...
                            <div class="tends col-lg-6 col-xs-12 gredient-border upload-video-single-comp standard-form my-3 p-0">
                                ...
                                <div class="bg-white p-3 comp-reg-form">
                                    ...
                                    ?>
                                    <span class="registration_btm_text text-center">By continuing, you agree to our <a href="<?php echo site_url('terms-conditions'); ?>">Terms and Conditions</a>, <a href="<?php echo site_url('privacy-policy'); ?>">Priavcy Policy</a> and <a href="<?php echo site_url('rules'); ?>">Contest Rules.</a></span>
