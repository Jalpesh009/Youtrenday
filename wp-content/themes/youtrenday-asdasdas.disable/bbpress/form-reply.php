	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
				<!-- <legend><?php /*  printf( esc_html__( 'Reply To: %s', 'bbpress' ), ( bbp_get_form_reply_to() ) ? sprintf( esc_html__( 'Reply #%1$s in %2$s', 'bbpress' ), bbp_get_form_reply_to(), bbp_get_topic_title() ) : bbp_get_topic_title() ); */ ?>
				</legend> -->
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit for-button-style"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
