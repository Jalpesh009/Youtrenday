	...
	<div id="register-page"class="page register-page">
		...
		<?php bp_nouveau_template_notices(); ?>
			...
			<?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>
				...
				<label for="signup_email"><?php _e( 'Email', 'buddypress' ); ?></label>
				<?php
				...
				<label for="signup_password"><?php _e( 'Password', 'buddypress' ); ?></label>
				<?php
...
<script>
	...
	{
		//alert("hello");
		jQuery('#field_18_day option:contains("----")').text('Day');
		jQuery('#field_18_month option:contains("----")').text('Month');
		jQuery('#field_18_year option:contains("----")').text('Year');
		...
		jQuery('#submit').click(function()
		{
			...
			//alert(username);
			jQuery('#signup_username').attr('value', username);
		});
